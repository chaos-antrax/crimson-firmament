...
export function BookManager({ books, onCreateBook, onSelectBook }: BookManagerProps) {
          ...
          {books.map((book) => (
            ...
            >
              <CardHeader>
                ...
                <CardDescription>Last updated: {book.updatedAt.toLocaleDateString()}</CardDescription>
              </CardHeader>
            </Card>
          ))}
        </div>
